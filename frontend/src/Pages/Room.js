    ...
    return (
        <>
            <div className="flex flex-col sm:flex-row items-center justify-around w-full h-48 py-5 shadow-lg bg-dark-eye" >
                ...
                <div className='flex w-full items-center justify-center sm:justify-end sm:mr-4'>
                    <button className="block m-3 px-6 py-3 bg-green-600 hover:bg-indigo-600 focus:outline-none rounded">
                        <p className="text-sm font-medium leading-none text-white">External URLs</p>
                    </button>
            ...
            <div className="w-full sm:px-6">
                <div className="bg-gray-100 shadow px-4 md:px-10 pt-4 md:pt-7 pb-5 overflow-y-auto">
